...
const config: HardhatUserConfig = {
  ...
  networks: {
    hardhat: {
      ...
      accounts: [{privateKey: process.env.HUMAN_ACCOUNT_PRIVATE_KEY || 'ac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80', balance:'10000000000000000000000'},
